...
#define RSC_HEALTHBAR_BORDER "./Sprites/Misc/HealthBarBorder.png"
...
#define RSC_WOODEN_BOARD_RIGHT "./Sprites/Misc/WoodSignTopRight.png"
#define RSC_WOODEN_BOARD_LEFT "./Sprites/Misc/WoodSignTopLeft.png"
